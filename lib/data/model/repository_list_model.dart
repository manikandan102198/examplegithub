...
List<RepositoryListModel> repositoryListModelFromJson(dynamic str) =>
    List<RepositoryListModel>.from(
        str.map((x) => RepositoryListModel.fromJson(x)));

String repositoryListModelToJson(List<RepositoryListModel> data) =>
