...
RepositoryViewModel repositoryViewModelFromJson(String str) =>
    RepositoryViewModel.fromJson(json.decode(str));

String repositoryViewModelToJson(RepositoryViewModel data) =>
    json.encode(data.toJson());

class RepositoryViewModel extends Equatable {
  ...
  final RepositoryViewModel? parent;
  final RepositoryViewModel? source;
  final int? networkCount;
  final int? subscribersCount;

  factory RepositoryViewModel.fromJson(Map<String, dynamic> json) =>
      RepositoryViewModel(
        id: json["id"],
        nodeId: json["node_id"],
        name: json["name"],
        ...
        parent: json["parent"] == null
            ? null
            : RepositoryViewModel.fromJson(json["parent"]),
        source: json["source"] == null
            ? null
            : RepositoryViewModel.fromJson(json["source"]),
